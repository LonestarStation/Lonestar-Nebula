...
/datum/map_template/lonestar/junkyard
	...
	template_categories = list(/datum/map/lonestar::MAP_TEMPLATE_CATEGORY_LONESTAR_JUNKYARD)
...
/datum/map_template/lonestar/junkyard/containment1
	...
	mappaths = list('maps/lonestar/submaps/junkyard/containment1.dmm')
	cost = 10
...
/datum/map_template/lonestar/junkyard/containment2
	...
	desc = "The remains of a severely damaged military shuttle, it could still have some cargo."
	mappaths = list('maps/lonestar/submaps/junkyard/containment2.dmm')
	cost = 10
//	template_group = "Containment Shuttle"
...
/datum/map_template/lonestar/junkyard/containment3
	...
	desc = "The remains of a severely damaged military shuttle, it could still have some cargo."
	mappaths = list('maps/lonestar/submaps/junkyard/containment3.dmm')
	cost = 10
//	template_group = "Containment Shuttle"
...
/datum/map_template/lonestar/junkyard/containment4
	...
	desc = "The remains of a severely damaged military shuttle, it could still have some cargo."
	mappaths = list('maps/lonestar/submaps/junkyard/containment4.dmm')
	cost = 10
//	template_group = "Containment Shuttle"
...
/datum/map_template/lonestar/junkyard/containment5
	...
	desc = "The remains of a severely damaged military shuttle, it could still have some cargo."
	mappaths = list('maps/lonestar/submaps/junkyard/containment5.dmm')
	cost = 10
//	template_group = "Containment Shuttle"
...
/datum/map_template/lonestar/junkyard/decoupled_engine
	...
	mappaths = list('maps/lonestar/submaps/junkyard/decoupled_engine.dmm')
	cost = 10
...
/datum/map_template/lonestar/junkyard/medical1
	...
	mappaths = list('maps/lonestar/submaps/junkyard/medical1.dmm')
	cost = 10
...
/datum/map_template/lonestar/junkyard/medical2
	...
	desc = "The remains of a severely damaged medical shuttle, it could still have some cargo."
	mappaths = list('maps/lonestar/submaps/junkyard/medical2.dmm')
	cost = 10
//	template_group = "Medical Shuttle"
...
/datum/map_template/lonestar/junkyard/mercenary1
	...
	mappaths = list('maps/lonestar/submaps/junkyard/mercenary1.dmm')
	cost = 10
...
/datum/map_template/lonestar/junkyard/mercenary2
	...
	desc = "A ship Lonestar managed to buy at a discount... because of the bodies."
	mappaths = list('maps/lonestar/submaps/junkyard/mercenary2.dmm')
	cost = 10
//	template_group = "Mercenary Shuttle"
...
/datum/map_template/lonestar/junkyard/mercenary3
	...
	desc = "A ship Lonestar managed to buy at a discount... because of the bodies."
	mappaths = list('maps/lonestar/submaps/junkyard/mercenary3.dmm')
	cost = 10
//	template_group = "Mercenary Shuttle"
...
/datum/map_template/lonestar/junkyard/quarantine
	...
	desc = "A ship Lonestar managed to buy at a discount... because of the bodies."
	mappaths = list('maps/lonestar/submaps/junkyard/quarantine.dmm')
	cost = 10
...
/datum/map_template/lonestar/junkyard/crystal_growth
	...
	mappaths = list('maps/lonestar/submaps/junkyard/crystal_growth.dmm')
	cost = 5
...
/datum/map_template/lonestar/junkyard/dropped_supplies
	...
	mappaths = list('maps/lonestar/submaps/junkyard/dropped_supplies.dmm')
	cost = 5
...
/datum/map_template/lonestar/junkyard/escape_pods1
	...
	mappaths = list('maps/lonestar/submaps/junkyard/escape_pods1.dmm')
	cost = 5
...
/datum/map_template/lonestar/junkyard/escape_pods2
	name = "Escape Pods 2"
	desc = "A group of vacant Emergency pods, maybe somebody left their personal effects behind."
	mappaths = list('maps/lonestar/submaps/junkyard/escape_pods2.dmm')
	cost = 5
//	template_group = "Escape Pods"
...
/datum/map_template/lonestar/junkyard/escape_pods3
	name = "Escape Pods 3"
	desc = "A group of vacant Emergency pods, maybe somebody left their personal effects behind."
	mappaths = list('maps/lonestar/submaps/junkyard/escape_pods3.dmm')
	cost = 5
//	template_group = "Escape Pods"
...
/datum/map_template/lonestar/junkyard/escape_pods4
	name = "Escape Pods 4"
	desc = "A group of vacant Emergency pods, maybe somebody left their personal effects behind."
	mappaths = list('maps/lonestar/submaps/junkyard/escape_pods4.dmm')
	cost = 5
//	template_group = "Escape Pods"
...
/datum/map_template/lonestar/junkyard/grease_pile1
	...
	mappaths = list('maps/lonestar/submaps/junkyard/grease_pile1.dmm')
	cost = 5

/datum/map_template/lonestar/junkyardv/grease_pile2
	name = "Grease Pile 2"
	desc = "A pile of grease."
	mappaths = list('maps/lonestar/submaps/junkyard/grease_pile2.dmm')
	cost = 5

/datum/map_template/lonestar/junkyard/grease_pile3
	name = "Grease Pile 3"
	desc = "A pile of grease."
	mappaths = list('maps/lonestar/submaps/junkyard/grease_pile3.dmm')
	cost = 5

/datum/map_template/lonestar/junkyard/grease_pile4
	name = "Grease Pile 4"
	desc = "A pile of grease."
	mappaths = list('maps/lonestar/submaps/junkyard/grease_pile4.dmm')
	cost = 5

/datum/map_template/lonestar/junkyard/grease_pile5
	name = "Grease Pile 5"
	desc = "A pile of grease."
	mappaths = list('maps/lonestar/submaps/junkyard/grease_pile5.dmm')
	cost = 5
...
//	desc = "How did this old thing get all the way out here?"
	...
	mappaths = list('maps/lonestar/submaps/junkyard/pascal_b.dmm')
	cost = 5
//	discard_prob = 85
...
/datum/map_template/lonestar/junkyard/rodeo_pit
	...
	mappaths = list('maps/lonestar/submaps/junkyard/rodeo_pit.dmm')
	cost = 5