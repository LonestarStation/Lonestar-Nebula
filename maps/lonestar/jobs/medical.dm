/datum/job/lonestar/cmo
	...
	outfit_type = /decl/outfit/job/medical/cmo/lonestar
	min_skill = list(
...
/datum/job/lonestar/doctor
	...
	outfit_type = /decl/outfit/job/medical/medical_officer
	min_skill = list(
		SKILL_LITERACY = SKILL_ADEPT,
...
/datum/job/lonestar/commando
	title = "Lonestar Commando"
//	hud_icon_state = "hudpharmacist" //TODO
	department_types = list(/decl/department/medical)
	minimal_player_age = 7
	total_positions = 5
	spawn_positions = 3
	supervisors = "any medical officer"
	selection_color = "#013d3b"
	economic_power = 3
	access = list(
		access_maint_tunnels,
...
/datum/job/lonestar/chaplain
	...
	outfit_type = /decl/outfit/job/chaplain/lonestar
	is_holy = TRUE
	min_skill = list(
		SKILL_LITERACY = SKILL_ADEPT,
		SKILL_MEDICAL  = SKILL_BASIC
