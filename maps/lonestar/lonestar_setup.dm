/datum/map/lonestar/send_welcome()
	var/obj/effect/overmap/visitable/sector/lonestar = SSshuttle.ship_by_type(/obj/effect/overmap/visitable/sector/lonestar)
	...
	if(lonestar) //If the overmap is disabled, it's possible for there to be no lonestar.
		var/list/space_things = list()
		welcome_text += "Current Coordinates:<br /><b>[lonestar.x]:[lonestar.y]</b><br /><br>"
...
//		welcome_text += "Time since last port visit:<br /><b>[rand(60,180)] days</b><br /><hr>"
		...
		for(var/obj/effect/overmap/visitable/O in space_things)
			...
			if(O.loc != lonestar.loc)
				var/bearing = round(90 - Atan2(O.x - lonestar.x, O.y - lonestar.y),5) //fucking triangles how do they work
				if(bearing < 0)
					bearing += 360
