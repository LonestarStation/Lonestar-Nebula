...
/obj/item/clothing/jumpsuit/chief_medical_officer/mash
	...
	icon = 'icons/clothing/jumpsuits/jumpsuit_cmo_mash.dmi'
	permeability_coefficient = 0.50
	armor = list(
		ARMOR_BIO = ARMOR_BIO_MINOR
		)
...
/obj/item/clothing/jumpsuit/medical/mash
	...
	icon = 'icons/clothing/jumpsuits/jumpsuit_medical_officer.dmi'
	permeability_coefficient = 0.50
	armor = list(
		ARMOR_BIO = ARMOR_BIO_MINOR
	)
...
/obj/item/clothing/jumpsuit/medical/commando
	...
	icon = 'icons/clothing/jumpsuits/jumpsuit_commando.dmi'
	armor = list(
...
/obj/item/clothing/jumpsuit/security/lonestar_lawman
	...
	icon = 'icons/clothing/jumpsuits/jumpsuit_lawman.dmi'
	armor = list(
		ARMOR_MELEE = ARMOR_MELEE_SMALL
	)
	siemens_coefficient = 0.9
...
/obj/item/clothing/jumpsuit/mechanic
	...
	icon = 'icons/clothing/jumpsuits/jumpsuit_mechanic.dmi'
	armor = list(
		ARMOR_MELEE = ARMOR_MELEE_SMALL
		)
	siemens_coefficient = 0.8
...
/obj/item/clothing/jumpsuit/ranch_hand
	...
	icon = 'icons/clothing/jumpsuits/jumpjeans_ranch.dmi'
	permeability_coefficient = 0.50
	armor = list(
		ARMOR_BIO = ARMOR_BIO_MINOR
		)
...
/obj/item/clothing/jumpsuit/ranchman
	...
	icon = 'icons/clothing/uniform_ranch_manager.dmi'
	permeability_coefficient = 0.50
	armor = list(
		ARMOR_BIO = ARMOR_BIO_MINOR
		)
...
/obj/item/clothing/jumpsuit/frontier
	...
	icon = 'icons/clothing/jumpsuits/jumpsuit_country.dmi'